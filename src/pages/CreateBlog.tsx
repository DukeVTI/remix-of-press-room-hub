    ...
    try {
      ...
      const { data: blog, error: blogError } = await supabase
        ...
        .insert({
          ...
          profile_photo_alt: photoAlt.trim(),
        ...
        <div className="card-premium">
          ...
          <form onSubmit={handleSubmit} className="space-y-8" noValidate>
            ...
            <div className="space-y-3">
              ...
              {/* Alt Text for Photo - for accessibility */}
              {profilePhoto && (
                <div className="mt-4 space-y-2">
                  <CharacterCountInput
                    ...
                    required
                    placeholder="Describe the image for screen readers, e.g. 'Logo showing a red mountain with sunrise'"
                    ariaLabel="Image alt text for screen readers"
                    className={errors.photoAlt ? "border-destructive" : ""}
                    disabled={isLoading}
                  />
                  <p className="text-xs text-muted-foreground">
                    This helps visually impaired readers understand your blog's image.
                  </p>
                  {errors.photoAlt && (
